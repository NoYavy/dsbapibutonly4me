(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? module.exports = factory(require('pako'), require('percentage-calc')) :
    typeof define === 'function' && define.amd ? define(['pako', 'percentage-calc'], factory) :
    (global = typeof globalThis !== 'undefined' ? globalThis : global || self, global.dsbapi = factory(global.pako, global.percentage));
})(this, (function (pako, percentage) { 'use strict';

    function _interopDefaultLegacy (e) { return e && typeof e === 'object' && 'default' in e ? e : { 'default': e }; }

    var pako__default = /*#__PURE__*/_interopDefaultLegacy(pako);
    var percentage__default = /*#__PURE__*/_interopDefaultLegacy(percentage);
    ...
    function Encode(ObjectToEncode) {
    	let b = pako__default["default"].deflate(JSON.stringify(ObjectToEncode), {
    		to: 'string',
    		gzip: !0
    	});
    	return (b = btoa(b));
    ...
    function Decode(ToDecode) {
    	let b = StringView.base64ToBytes(ToDecode),
    		c = pako__default["default"].inflate(b),
    		d = new StringView(c),
    		e = d.toString();
    	return JSON.parse(e);
    }
    ...
    class DSB {
    	...
    	async fetch(progress = () => {}) {
    		...
    		progress(percentage__default["default"].from(4, 5));
    		const decoded = Decode(response.data.d);
    		progress(percentage__default["default"].from(5, 5));
    		return decoded;
    	}
